        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              ...
              {/* Decorative Elements */}
              <div className="absolute -bottom-6 -left-6 w-24 h-24 bg-blue-100 rounded-full blur-xl opacity-50 -z-10"></div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              <h2 className="text-4xl lg:text-5xl font-heading font-bold text-slate-900 leading-tight">
                <span className="text-blue-600">智能的运营管理系统</span>，
                <br />
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow border border-slate-100 h-full flex flex-col">
                ...
                <p className="text-sm text-slate-600 leading-relaxed">
                  <span className="text-blue-600 font-medium">实时查看</span>
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow border border-slate-100 h-full flex flex-col">
                ...
                <p className="text-sm text-slate-600 leading-relaxed">
                  <span className="text-blue-600 font-medium">实时处理</span>
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow border border-slate-100 h-full flex flex-col">
                ...
                <p className="text-sm text-slate-600 leading-relaxed">
                  <span className="text-blue-600 font-medium">多账号</span>
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow border border-slate-100 h-full flex flex-col">
                ...
                <p className="text-sm text-slate-600 leading-relaxed">
                  <span className="text-blue-600 font-medium">我们提供</span>
